import { track, getScene, getAll, reset, fetchSummary } from './counter.js?v=10';
import { icon, media, loadSite, renderChrome } from './chrome.js?v=10';
import { initDb, dbGotowa, select } from './db.js?v=10';
import { zBazy, formatujCene } from './mapowanie.js?v=10';
