...
import { track } from './counter.js?v=36';
import { icon, esc, loadSite, renderChrome } from './chrome.js?v=36';
import { initDb, dbGotowa, select } from './db.js?v=36';
import { zBazy, naGrosze } from './mapowanie.js?v=36';
import { dodaj as doKoszyka } from './koszyk.js?v=36';
